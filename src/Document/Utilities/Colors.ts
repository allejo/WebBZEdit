// https://github.com/BZFlag-Dev/bzflag/blob/a249151/src/common/ParseColor.cxx
export const Colors: Record<string, [number, number, number]> = Object.freeze({
  alice_blue: [0.941176, 0.972549, 1.0],
  ...
  black: [0.0, 0.0, 0.0],
  blanched_almond: [1.0, 0.921569, 0.803922],
  blue1: [0.0, 0.0, 1.0],
  blue2: [0.0, 0.0, 0.933333],
  blue3: [0.0, 0.0, 0.803922],
  ...
  chocolate4: [0.545098, 0.270588, 0.07451],
  ...
  cyan: [0.0, 1.0, 1.0],
  dark_blue: [0.0, 0.0, 0.545098],
  dark_cyan: [0.0, 0.545098, 0.545098],
  dark_goldenrod: [0.721569, 0.52549, 0.043137],
  dark_gray: [0.662745, 0.662745, 0.662745],
  dark_green: [0.0, 0.392157, 0.0],
  dark_grey: [0.662745, 0.662745, 0.662745],
  dark_khaki: [0.741176, 0.717647, 0.419608],
  dark_magenta: [0.545098, 0.0, 0.545098],
  dark_olive_green: [0.333333, 0.419608, 0.184314],
  dark_orange: [1.0, 0.54902, 0.0],
  dark_orchid: [0.6, 0.196078, 0.8],
  dark_red: [0.545098, 0.0, 0.0],
  ...
  dark_turquoise: [0.0, 0.807843, 0.819608],
  dark_violet: [0.580392, 0.0, 0.827451],
  deep_pink: [1.0, 0.078431, 0.576471],
  deep_sky_blue: [0.0, 0.74902, 1.0],
  dim_gray: [0.411765, 0.411765, 0.411765],
  dim_grey: [0.411765, 0.411765, 0.411765],
  dodger_blue: [0.117647, 0.564706, 1.0],
  ...
  green: [0.0, 1.0, 0.0],
  green_yellow: [0.678431, 1.0, 0.184314],
  ...
  hot_pink: [1.0, 0.411765, 0.705882],
  ...
  lavender_blush: [1.0, 0.941176, 0.960784],
  lawn_green: [0.486275, 0.988235, 0.0],
  lemon_chiffon: [1.0, 0.980392, 0.803922],
  light_blue: [0.678431, 0.847059, 0.901961],
  light_coral: [0.941176, 0.501961, 0.501961],
  light_cyan: [0.878431, 1.0, 1.0],
  ...
  light_green: [0.564706, 0.933333, 0.564706],
  light_grey: [0.827451, 0.827451, 0.827451],
  light_pink: [1.0, 0.713726, 0.756863],
  light_salmon: [1.0, 0.627451, 0.478431],
  light_sea_green: [0.12549, 0.698039, 0.666667],
  light_sky_blue: [0.529412, 0.807843, 0.980392],
  light_slate_blue: [0.517647, 0.439216, 1.0],
  light_slate_gray: [0.466667, 0.533333, 0.6],
  light_slate_grey: [0.466667, 0.533333, 0.6],
  light_steel_blue: [0.690196, 0.768627, 0.870588],
  light_yellow: [1.0, 1.0, 0.878431],
  ...
  medium_spring_green: [0.0, 0.980392, 0.603922],
  medium_turquoise: [0.282353, 0.819608, 0.8],
  medium_violet_red: [0.780392, 0.082353, 0.521569],
  midnight_blue: [0.098039, 0.098039, 0.439216],
  mint_cream: [0.960784, 1.0, 0.980392],
  misty_rose: [1.0, 0.894118, 0.882353],
  moccasin: [1.0, 0.894118, 0.709804],
  navajo_white: [1.0, 0.870588, 0.678431],
  navy: [0.0, 0.0, 0.501961],
  navy_blue: [0.0, 0.0, 0.501961],
  ...
  orange_red: [1.0, 0.270588, 0.0],
  orchid1: [1.0, 0.513726, 0.980392],
  ...
  papaya_whip: [1.0, 0.937255, 0.835294],
  peach_puff: [1.0, 0.854902, 0.72549],
  ...
  saddle_brown: [0.545098, 0.270588, 0.07451],
  ...
  spring_green: [0.0, 1.0, 0.498039],
  steel_blue: [0.27451, 0.509804, 0.705882],
  ...
  violet_red: [0.815686, 0.12549, 0.564706],
...
export type ColorLiteral = keyof typeof Colors;
export const ColorLiterals = Object.freeze(new Set(Object.keys(Colors)));
...
export function getRgbValue(value: ColorLiteral): [number, number, number] {
  return Colors[value];
}
